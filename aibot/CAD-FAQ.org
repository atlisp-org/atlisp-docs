...
未能加载文件或程序集“file:///C:\Users\vitalgg\@lisp\packages\at-sidebar\net\at-sidebar-Aut
oCAD.dll”或它的某一个依赖项。生成此程序集的运行时比当前加载的运行时新，无法加载此程序集。
文件名:“file:///C:\Users\vitalgg\@lisp\packages\at-sidebar\net\at-sidebar-AutoCAD.d
ll”
